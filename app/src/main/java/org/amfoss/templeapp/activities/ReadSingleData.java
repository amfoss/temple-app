        ...
        public void radioGroup(RadioGroup group, int checkedId) {
            switch (checkedId) {
                case R.id.radio_donate:
                    ...
                    flag = 0;
                    Toast.makeText(getBaseContext(), getString(R.string.Toast_donate), Toast.LENGTH_SHORT)
                            .show();
                    break;
                case R.id.radio_pooja:
                    binding.totalView.setVisibility(View.VISIBLE);
                    flag = 1;
                    Toast.makeText(getBaseContext(), getString(R.string.Toast_Pooja), Toast.LENGTH_SHORT)
                            .show();
                    break;
            }
        }
